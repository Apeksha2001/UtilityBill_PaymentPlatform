package com.finzly.UtilityBill_PaymentPlatform.utility;
...
import com.finzly.UtilityBill_PaymentPlatform.exception.ValidationException;
...
public class Validation {
	...
	public static void validateId(long Id) { // customer Id is aadhar number
	...
	public static void validateUnitConsumed(double unitConsumed) {
		if (unitConsumed < 0) {
			throw new ValidationException("Unit consumed must be positive");
		}
	}

	public static void validateBillDates(Date billStartDate, Date billDueDate) {
	...
	public static void validateTelephoneNumber(String telephoneNumber) {
